var creationPerso = {
    ...
    'init': function () {
        ...
        for (i in attributs) {
            listeAttributs += '<tr class="ligne_carac"><td>' + attributs[i].label + '</td><td><input id="base_' + attributs[i].short + '" class="base_carac" type="number" value="8" min="8" max="15" /></td><td>+</td><td id="racial_for" class="racial_bonus">0</td><td>=</td><td class="base_plus_racial">8</td><td class="computed_bonus" id="bonus_' + attributs[i].short + '">-1</td></tr>';
        }
